...
| **FEAT-04** | Async Scan Job & Webhook Callback | Async Queue | ✅ **ACTIVE** | `asyncscan.Queue`, `api.Server` | [`internal/asyncscan/queue.go`](file:///home/ubuntu/workspace/plan/clamav-service/internal/asyncscan/queue.go), [`internal/api/server.go`](file:///home/ubuntu/workspace/plan/clamav-service/internal/api/server.go) |
...
| **FEAT-14** | Embedded Web Admin Dashboard (SPA) | Management | ✅ **ACTIVE** | `web`, `api.Server` | [`web/embed.go`](file:///home/ubuntu/workspace/plan/clamav-service/web/embed.go), [`web/static/`](file:///home/ubuntu/workspace/plan/clamav-service/web/static/) |
